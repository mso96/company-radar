...
export interface SenderProfile { agencyName: string; address: PostalAddress; replyEmail: string; website?: string; optOutText: string; logoUrl?: string; logoWidth?: number; accentColor?: string; primaryColor?: string; textColor?: string; fontFamily?: string; headerAlignment?: "left" | "center" | "right" }
