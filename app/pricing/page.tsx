...
const mailFeatures = ["Prepaid physical-mail credits", "Address validation before send", "Print and dispatch status", "Automatic refund on confirmed provider failure"]
